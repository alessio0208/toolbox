...
# MODIFIED
time1 = datetime.now()
print('[' + str(time1) + '] Cross validation...')
# MODIFIED END 
...
###if len(sys.argv) > 2:
	...
	time3 = datetime.now()
	print('[' + str(time3) + '] Testing...')
	Popen(cmd, shell = True).communicate()
	print('[########## ########] Output prediction: {0}'.format(predict_test_file))
	print('[' + str(datetime.now()) + '] Time: Cross-Validation (' + str(time2-time1) + '), Training (' + str(time3-time2) + ')')
# MODIFIED
	...
	time4 = datetime.now()
	print('[' + str(time4) + '] Time: Cross-Validation (' + str(time2-time1) + '), Training (' + str(time4-time2) + ')')
# MODIFIED END 
